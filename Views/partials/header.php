...
$dashboardOpen = sidebar_is_active([
    '/AdminLTE3/Views/back/ecommerce/dashboard.php',
    '/AdminLTE3/Views/back/defis/dashboard.php',
    '/AdminLTE3/Views/back/nutrition/dashboard.php',
    '/AdminLTE3/Views/back/entrainements/dashboard.php',
...
$nutritionOpen = sidebar_is_active('/AdminLTE3/Views/back/nutrition/');
$entrainementsOpen = sidebar_is_active('/AdminLTE3/Views/back/entrainements/');
...
<head>
    ...
    <link rel="stylesheet" href="/AdminLTE3/assets/css/stabilis.css?v=8">
...
<div class="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-brand">
            <img src="/AdminLTE3/assets/img/logo.png" alt="Stabilis">
    ...
    <ul class="sidebar-nav">
        <li class="sidebar-group <?php echo $dashboardOpen ? 'is-open' : ''; ?>" data-sidebar-group="dashboard">
            ...
            <ul class="sidebar-subnav">
                <li><a href="/AdminLTE3/Views/back/ecommerce/dashboard.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/ecommerce/dashboard.php') ? 'active' : ''; ?>"><i class="fas fa-store"></i> <span>E-commerce</span></a></li>
                <li><a href="/AdminLTE3/Views/back/defis/dashboard.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/defis/dashboard.php') ? 'active' : ''; ?>"><i class="fas fa-trophy"></i> <span>Defis</span></a></li>
                <li><a href="/AdminLTE3/Views/back/nutrition/dashboard.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/dashboard.php') ? 'active' : ''; ?>"><i class="fas fa-utensils"></i> <span>Nutrition</span></a></li>
                <li><a href="/AdminLTE3/Views/back/entrainements/dashboard.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/dashboard.php') ? 'active' : ''; ?>"><i class="fas fa-dumbbell"></i> <span>Entrainements</span></a></li>
        ...
        <li class="sidebar-group <?php echo $nutritionOpen ? 'is-open' : ''; ?>" data-sidebar-group="nutrition">
            <button type="button" class="sidebar-group-toggle <?php echo $nutritionOpen ? 'active' : ''; ?>" aria-expanded="<?php echo $nutritionOpen ? 'true' : 'false'; ?>">
                <span><i class="fas fa-utensils"></i> <span>Nutrition</span></span>
                <i class="fas fa-chevron-down sidebar-chevron"></i>
            </button>
            <ul class="sidebar-subnav">
                <li><a href="/AdminLTE3/Views/back/nutrition/aliment-ajout.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/aliment-ajout.php') ? 'active' : ''; ?>"><i class="fas fa-plus"></i> <span>Ajouter aliment</span></a></li>
                <li><a href="/AdminLTE3/Views/back/nutrition/aliments.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/aliments.php') ? 'active' : ''; ?>"><i class="fas fa-apple-alt"></i> <span>Liste aliments</span></a></li>
                <li><a href="/AdminLTE3/Views/back/nutrition/recette-ajout.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/recette-ajout.php') ? 'active' : ''; ?>"><i class="fas fa-plus"></i> <span>Ajouter recette</span></a></li>
                <li><a href="/AdminLTE3/Views/back/nutrition/recettes.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/recettes.php') ? 'active' : ''; ?>"><i class="fas fa-utensils"></i> <span>Liste recettes</span></a></li>
                <li><a href="/AdminLTE3/Views/back/nutrition/amelioration.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/nutrition/amelioration.php') ? 'active' : ''; ?>"><i class="fas fa-robot"></i> <span>Amelioration IA</span></a></li>
            </ul>
        </li>

        <li class="sidebar-group <?php echo $entrainementsOpen ? 'is-open' : ''; ?>" data-sidebar-group="entrainements">
            <button type="button" class="sidebar-group-toggle <?php echo $entrainementsOpen ? 'active' : ''; ?>" aria-expanded="<?php echo $entrainementsOpen ? 'true' : 'false'; ?>">
                <span><i class="fas fa-dumbbell"></i> <span>Entrainements</span></span>
                <i class="fas fa-chevron-down sidebar-chevron"></i>
            </button>
            <ul class="sidebar-subnav">
                <li><a href="/AdminLTE3/Views/back/entrainements/liste.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/liste.php') ? 'active' : ''; ?>"><i class="fas fa-running"></i> <span>Entrainements</span></a></li>
                <li><a href="/AdminLTE3/Views/back/entrainements/ajout.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/ajout.php') ? 'active' : ''; ?>"><i class="fas fa-plus"></i> <span>Ajouter entrainement</span></a></li>
                <li><a href="/AdminLTE3/Views/back/entrainements/seances.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/seances.php') ? 'active' : ''; ?>"><i class="fas fa-fire"></i> <span>Seances</span></a></li>
                <li><a href="/AdminLTE3/Views/back/entrainements/seance-ajout.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/seance-ajout.php') ? 'active' : ''; ?>"><i class="fas fa-stopwatch"></i> <span>Ajouter seance</span></a></li>
                <li><a href="/AdminLTE3/Views/back/entrainements/ai-history.php" class="<?php echo sidebar_is_active('/AdminLTE3/Views/back/entrainements/ai-history.php') ? 'active' : ''; ?>"><i class="fas fa-robot"></i> <span>Historique IA</span></a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="/AdminLTE3/Views/front/home/index.php" class="sidebar-link">
