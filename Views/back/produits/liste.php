            ...
            <tbody>
                ...
                if ($count == 0) {
                    ...
                    foreach ($produits as $p) {
                        ...
                        echo '<tr>';
                        echo '<td>#' . $p['id'] . '</td>';
                        echo '<td><img src="/AdminLTE3/assets/img/' . $image . '" class="product-img" onerror="this.src=\'/AdminLTE3/assets/img/default-product.png\'"></td>';
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td><img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($image); ?>" class="product-img" onerror="this.src='/AdminLTE3/assets/img/default-product.png'"></td>
                        ...
                        <td>
                            <a href="../../front/boutique/pack.php?id=<?php echo (int)$pack['id']; ?>" class="btn-icon"><i class="fas fa-eye"></i> <span>Voir</span></a>
