        ...
        <div class="container">
            ...
            <div class="cart-container">
                <div class="cart-items">
                    ...
                    <div class="cart-item">
                        <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($pack['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($pack['nom']); ?>" class="item-image" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                    ...
                    <div class="cart-item">
                        <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($product['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($product['nom']); ?>" class="item-image" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                        <div class="item-details">
