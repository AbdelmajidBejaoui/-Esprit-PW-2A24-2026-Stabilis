...
<body class="page-home">
        ...
        <div class="container home-hero-grid">
            <div class="home-hero-copy">
                ...
                <div class="home-hero-actions" data-reveal="zoom">
                    ...
                    <a href="../boutique/shop.php" class="home-btn secondary"><i class="fas fa-shopping-bag"></i> Boutique</a>
                </div>
            </div>
    ...
    <section class="home-training-hook">
        <div class="container home-training-grid">
            <span class="home-training-kicker" data-reveal="up">Entrainements</span>
            <div class="home-training-media" data-reveal="zoom">
                <img src="https://images.unsplash.com/photo-1571902943202-507ec2618e8f?auto=format&fit=crop&q=80&w=1400" alt="Entrainement sportif">
                <a href="../entrainements/index.php" class="home-image-cta"><i class="fas fa-arrow-right"></i> Aller aux entrainements</a>
            </div>
            <div class="home-training-copy" data-reveal="up">
                <h2>Generez, sauvegardez et suivez vos seances sportives.</h2>
                <p>Un espace clair pour construire une seance selon votre objectif, l'ajouter a votre programme, enregistrer vos efforts et visualiser votre progression.</p>
                <div class="home-training-actions">
                    <a href="../entrainements/index.php#programme" class="home-btn primary"><i class="fas fa-list-check"></i> Mon programme</a>
                    <a href="../entrainements/index.php#generateur" class="home-btn secondary dark"><i class="fas fa-robot"></i> Generateur IA</a>
                </div>
                <div class="home-training-mini" data-stagger-children>
                    <div data-reveal="up"><i class="fas fa-fire"></i><strong>Calories</strong><small>Calcul automatique MET</small></div>
                    <div data-reveal="up"><i class="fas fa-heart-pulse"></i><strong>Suivi</strong><small>Intensite, FC, notes</small></div>
                    <div data-reveal="up"><i class="fas fa-book-open"></i><strong>Tutoriels</strong><small>Etapes sauvegardees</small></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="home-shop-preview">
        <div class="container">
                ...
                <div class="product-card" data-reveal="zoom">
                    ...
                    <div class="product-content">
                        ...
                        <div class="product-actions">
                            <a href="../boutique/product.php?id=<?php echo (int) $produit['id']; ?>" class="btn-view"><i class="fas fa-eye"></i> Voir</a>
                            <a href="../boutique/cart.php?action=add&id=<?php echo (int) $produit['id']; ?>" class="btn-cart"><i class="fas fa-cart-plus"></i> Ajouter</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div data-reveal="up" class="u-section-footer">
                <a href="../boutique/shop.php" class="btn-primary u-section-footer-cta"><i class="fas fa-th-large"></i> Voir toute la boutique</a>
            </div>
        </div>
    </section>
    ...
    <footer class="u-footer">
        <div class="container">
            <div data-reveal="up" class="u-center">
                <img class="u-footer-logo" src="/AdminLTE3/assets/img/logo.png" alt="Stabilis">
    ...
    .home-defis-preview, .home-training-hook, .home-nutrition-hook, .home-shop-preview, .home-about { padding:84px 0; }
    .home-training-hook, .home-nutrition-hook, .home-shop-preview, .home-about { margin-top:18px; }
    .home-defis-preview { background:#fff; }
    .home-training-hook { background:#f8fbf9; }
    .home-training-grid { display:grid; grid-template-columns:1fr .92fr; gap:34px; align-items:center; }
    .home-training-kicker { grid-column:1 / -1; display:block; justify-self:start; color:#129f72; font-size:13px; font-weight:900; text-transform:uppercase; letter-spacing:.5px; margin:0 0 -12px; text-align:left; }
    .home-training-media { position:relative; min-height:430px; border-radius:24px; overflow:hidden; box-shadow:0 22px 46px rgba(35,56,41,.14); }
    .home-training-media::after { content:""; position:absolute; inset:0; background:linear-gradient(90deg, rgba(18,54,40,.18), rgba(18,54,40,.02)); pointer-events:none; }
    .home-training-media img { width:100%; height:100%; object-fit:cover; display:block; }
    .home-training-copy { justify-self:start; text-align:left; width:100%; }
    .home-training-copy h2 { margin:0 0 14px; color:#183d2f; font-size:clamp(30px,4vw,52px); line-height:1.08; font-weight:900; }
    .home-training-copy p { margin:0; color:#56635a; font-size:17px; line-height:1.65; }
    .home-training-actions { display:flex; gap:12px; flex-wrap:wrap; margin-top:24px; }
    .home-training-mini { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:12px; margin-top:24px; }
    .home-training-mini div { min-height:118px; padding:16px; border-radius:18px; background:#fff; border:1px solid #e3eee6; box-shadow:0 12px 28px rgba(35,56,41,.08); }
    .home-training-mini i { width:40px; height:40px; display:inline-flex; align-items:center; justify-content:center; border-radius:14px; background:#e8f4eb; color:#129f72; margin-bottom:10px; }
    .home-training-mini strong { display:block; color:#17291f; }
    .home-training-mini small { display:block; margin-top:4px; color:#657166; font-weight:750; line-height:1.35; }
    ...
    .home-nutrition-copy span { display:flex; justify-content:flex-start; width:100%; color:#129f72; font-size:13px; font-weight:900; text-transform:uppercase; letter-spacing:.5px; margin:0 0 10px; text-align:left; }
    ...
    .home-nutrition-card { min-height:160px; display:flex; flex-direction:column; align-items:flex-start; justify-content:flex-start; gap:10px; padding:28px; border-radius:22px; text-decoration:none; background:rgba(255,255,255,.9); border:1px solid rgba(210,228,215,.9); color:#1a4d3a; box-shadow:0 18px 40px rgba(35,56,41,.10); transition:transform .18s ease, box-shadow .18s ease, border-color .18s ease; }
    .home-nutrition-card:hover { transform:translateY(-6px); box-shadow:0 24px 48px rgba(35,56,41,.16); border-color:#bcdcc6; }
    .home-nutrition-card i { width:56px; height:56px; display:inline-flex; align-items:center; justify-content:center; border-radius:18px; background:#e7f4ea; color:#129f72; font-size:23px; box-shadow:0 10px 22px rgba(35,56,41,.12); }
    .home-nutrition-card strong { color:#17291f; font-size:22px; line-height:1.15; margin-top:4px; }
    ...
    @media (max-width: 980px) {
        .home-hero-grid, .home-defis-layout, .home-training-grid, .home-nutrition-grid { grid-template-columns:1fr; }
    ...
    @media (max-width: 640px) {
        ...
        .home-nutrition-panel, .home-training-mini { grid-template-columns:1fr; }
