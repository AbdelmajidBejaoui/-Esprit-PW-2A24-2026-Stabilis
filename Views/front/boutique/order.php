...
<body class="page-order">
    <?php $activeFrontPage = 'cart'; require __DIR__ . '/../partials/navigation.php'; ?>
    <section class="checkout-section">
        <div class="container">
            ...
            <div class="success-box">
                ...
                <a href="shop.php" class="btn-primary" style="display:inline-flex; width:auto; padding:14px 24px; margin-top:16px;">Retour a la boutique</a>
            </div>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-item">
                        <div class="summary-product-info">
                            <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($pack['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($pack['nom']); ?>" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                            <div>
                    ...
                    <div class="summary-item">
                        <div class="summary-product-info">
                            <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($product['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($product['nom']); ?>" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                            <div>
