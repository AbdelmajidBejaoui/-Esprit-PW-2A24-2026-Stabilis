        ...
        <div class="container">
            ...
            <?php else: ?>
                ...
                <div class="preorder-grid">
                    ...
                    <aside class="panel">
                        <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($product['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($product['nom']); ?>" style="width:100%; height:220px; object-fit:cover; border-radius:12px;" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
