...
function renderPackCard(array $pack) {
    ...
    <div class="product-card shop-card" data-reveal="zoom">
        ...
        <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($pack['image_url']); ?>" alt="<?php echo htmlspecialchars($pack['nom']); ?>" class="product-image" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
        <?php else: ?>
        <div class="pack-card-slideshow">
            <?php foreach (($pack['items'] ?? []) as $index => $item): ?>
            <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($item['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($item['nom']); ?>" class="product-image pack-card-slide <?php echo $index === 0 ? 'is-active' : ''; ?>" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
            <?php endforeach; ?>
            <?php if (empty($pack['items'])): ?><img src="/AdminLTE3/assets/img/default-product.png" class="product-image" alt="Pack"><?php endif; ?>
        </div>
        <?php endif; ?>
...
<body class="page-shop">
    <?php $activeFrontPage = 'shop'; require __DIR__ . '/../partials/navigation.php'; ?>
