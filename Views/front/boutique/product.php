...
<body class="page-product">
    ...
    <div style="background: var(--bg-surface); padding: 16px 0; border-bottom: 1px solid var(--border-light);">
        <div class="container" data-reveal="up" style="font-size: 14px; color: var(--text-muted);">
            <a href="../home/index.php" style="color: var(--text-muted); text-decoration: none;">Accueil</a>
        ...
        <div class="container">
            <div class="product-container">
                <div class="product-image-container" data-reveal="left">
                    <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($product['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($product['nom']); ?>" class="product-image" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                </div>
                ...
                <?php foreach ($recommendedProducts as $recommendedProduct): ?>
                    ...
                    <div class="recommendation-card" data-reveal="zoom">
                        <a href="product.php?id=<?php echo (int)$recommendedProduct['id']; ?>" class="recommendation-image-link">
                            <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($recommendedProduct['image_url'] ?? 'default-product.png'); ?>" alt="<?php echo htmlspecialchars($recommendedProduct['nom']); ?>" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                        </a>
