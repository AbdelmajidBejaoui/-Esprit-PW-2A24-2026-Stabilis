        ...
        <div class="container">
            <div class="product-container">
                <div class="product-image-container">
                    ...
                    <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($pack['image_url'] ?? 'default-product.png'); ?>" class="product-image" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                    <?php else: ?>
                    <div class="pack-slideshow">
                        <?php foreach ($pack['items'] as $index => $item): ?>
                        <img src="/AdminLTE3/assets/img/<?php echo htmlspecialchars($item['image_url'] ?? 'default-product.png'); ?>" class="product-image pack-slide <?php echo $index === 0 ? 'is-active' : ''; ?>" alt="<?php echo htmlspecialchars($item['nom']); ?>" onerror="this.src='/AdminLTE3/assets/img/default-product.png'">
                        <?php endforeach; ?>
                    </div>
                    <?php endif; ?>
                </div>
