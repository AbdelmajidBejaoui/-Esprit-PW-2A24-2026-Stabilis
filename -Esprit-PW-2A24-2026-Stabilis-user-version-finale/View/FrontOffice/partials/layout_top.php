...
<head>
    ...
    <link rel="stylesheet" href="../../font-office/assets/css/front-style.css">

    <style>
        :root {
            --stb-green: #10b981;
            --stb-green-dark: #059669;
            --stb-mint: #d1fae5;
            --stb-ink: #1f2937;
        }
        body {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-vege">
        <div class="container">
            <a class="navbar-brand" href="../../front-office.php">
                <span class="brand-logo"><img src="../../assets/logo-stabilis.svg" alt="Stabilis"></span>
                Stabilis
            </a>
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item <?php echo $activePage === 'home' ? 'active' : ''; ?>">
                        <a class="nav-link" href="../../front-office.php">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../font-office/challenges.php">D&eacute;fis</a>
                    </li>
                    <?php if ($isLoggedIn): ?>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link" href="../../admin.php">BackOffice</a>
                    </li>
                </ul>
            </div>
        </div>
