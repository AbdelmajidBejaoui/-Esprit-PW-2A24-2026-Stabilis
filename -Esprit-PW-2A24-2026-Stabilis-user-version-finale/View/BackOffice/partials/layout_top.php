    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="../../admin.php" class="nav-link">Back office</a>
            </li>
        </ul>
    </nav>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="../../back-office/index.php" class="nav-link">
                            <i class="nav-icon fas fa-trophy"></i>
                            <p>Gestion des d&eacute;fis</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../../front-office.php" class="nav-link">
