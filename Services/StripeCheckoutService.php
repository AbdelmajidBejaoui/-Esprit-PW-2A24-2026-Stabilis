...
class StripeCheckoutService {
    ...
    public function createCheckoutSession(array $order, array $lineItems, $amountTotal) {
        ...
        $payload = [
            'mode' => 'payment',
            'success_url' => $baseUrl . '/Views/front/boutique/order.php?stripe=success&session_id={CHECKOUT_SESSION_ID}',
            'cancel_url' => $baseUrl . '/Views/front/boutique/order.php?stripe=cancel',
