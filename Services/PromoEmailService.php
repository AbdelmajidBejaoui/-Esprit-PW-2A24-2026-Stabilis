...
class PromoEmailService {
    ...
    public function __construct($pdo, $geminiApiKey, $mailConfig = null) {
        ...
        if (($this->config['method'] ?? '') === 'smtp' && !empty($smtp['username']) && !empty($smtp['password'])) {
    ...
    <div style="max-width:640px; margin:24px auto; background:#ffffff; border:1px solid #d9eadf; border-radius:14px; overflow:hidden;">
        ...
        <div style="padding:24px;">
            ...
            <div style="text-align:center; margin:26px 0 8px;">
                <a href="http://localhost/AdminLTE3/Views/front/boutique/shop.php" style="background:#1A4D3A; color:#ffffff; text-decoration:none; padding:13px 24px; border-radius:999px; font-weight:700; display:inline-block;">Voir la boutique</a>
            </div>
        </div>
